...
%prep
%setup -q -n rrdtool-1.8.0
cd %{_builddir}/rrdtool-1.8.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697574527
...
cp %{_builddir}/rrdtool-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/rrdtool/db95910cb27890d60e596e4c622fc3eeba6693fa || :
cp %{_builddir}/rrdtool-%{version}/bindings/python/COPYING %{buildroot}/usr/share/package-licenses/rrdtool/9a647436aa2324c4cb849c6f3d31c392ed50d9bd || :
%make_install
%find_lang rrdtool
